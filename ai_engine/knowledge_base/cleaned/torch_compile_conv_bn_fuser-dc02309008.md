---
title: "torch_compile_conv_bn_fuser.py"
source_path: "pytorch/intermediate_source/torch_compile_conv_bn_fuser.py"
source_type: code
---

# torch_compile_conv_bn_fuser.py

Source: `pytorch/intermediate_source/torch_compile_conv_bn_fuser.py`
