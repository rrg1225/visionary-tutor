---
title: "torch_export_aoti_python.py"
source_path: "pytorch/recipes_source/torch_export_aoti_python.py"
source_type: code
---

# torch_export_aoti_python.py

Source: `pytorch/recipes_source/torch_export_aoti_python.py`
