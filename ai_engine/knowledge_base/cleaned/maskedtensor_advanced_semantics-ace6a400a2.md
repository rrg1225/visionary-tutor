---
title: "maskedtensor_advanced_semantics.py"
source_path: "pytorch/unstable_source/maskedtensor_advanced_semantics.py"
source_type: code
---

# maskedtensor_advanced_semantics.py

Source: `pytorch/unstable_source/maskedtensor_advanced_semantics.py`
