---
title: "large-pretraining-transformers"
source_path: "d2l-en-master/d2l-en-master/chapter_attention-mechanisms-and-transformers/large-pretraining-transformers.md"
...
![Text-to-image examples by the Imagen model, whose text encoder is from T5 (figures taken from :citet:`saharia2022photorealistic`).](assets/large-pretraining-transformers-186e2a5546/imagen-42f48957e1.png)
:width:`700px`
:label:`fig_imagen`
...
![Aggregate performance of GPT-3 for all 42 accuracy-denominated benchmarks (caption adapted and figure taken from :citet:`brown2020language`).](assets/large-pretraining-transformers-186e2a5546/gpt3-xshot-scaling-5968887f99.png)
:width:`400px`
...
![Transformer language model performance improves smoothly as we increase the model size, dataset size, and amount of compute used for training. For optimal performance all three factors must be scaled up in tandem. Empirical performance has a power-law relationship with each individual factor when not bottlenecked by the other two (caption adapted and figure taken from :citet:`kaplan2020scaling`).](assets/large-pretraining-transformers-186e2a5546/scaling-power-law-591a4c4725.png)
:width:`700px`
...
![Transformer language model training runs (figure taken from :citet:`kaplan2020scaling`).](assets/large-pretraining-transformers-186e2a5546/scaling-sample-conv-9e18f01c45.png)
:width:`700px`
...
![Image examples generated from the same text by the Parti model of increasing sizes (350M, 750M, 3B, 20B) (examples taken from :citet:`yu2022scaling`).](assets/large-pretraining-transformers-186e2a5546/parti-0e60152889.png)
:width:`700px`
:label:`fig_parti`
