---
title: "neural_tangent_kernels.py"
source_path: "pytorch/intermediate_source/neural_tangent_kernels.py"
source_type: code
---

# neural_tangent_kernels.py

Source: `pytorch/intermediate_source/neural_tangent_kernels.py`
