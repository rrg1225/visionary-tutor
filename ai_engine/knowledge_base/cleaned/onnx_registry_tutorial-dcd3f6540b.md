---
title: "onnx_registry_tutorial.py"
source_path: "pytorch/beginner_source/onnx/onnx_registry_tutorial.py"
source_type: code
---

# onnx_registry_tutorial.py

Source: `pytorch/beginner_source/onnx/onnx_registry_tutorial.py`
