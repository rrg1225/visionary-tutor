---
title: "compiling_optimizer_lr_scheduler.py"
source_path: "pytorch/recipes_source/compiling_optimizer_lr_scheduler.py"
source_type: code
---

# compiling_optimizer_lr_scheduler.py

Source: `pytorch/recipes_source/compiling_optimizer_lr_scheduler.py`
