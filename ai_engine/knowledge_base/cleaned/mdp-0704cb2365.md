---
title: "mdp"
source_path: "d2l-en-master/d2l-en-master/chapter_reinforcement-learning/mdp.md"
...
![A simple gridworld navigation task where the robot not only has to find its way to the goal location (shown as a green house) but also has to avoid trap locations (shown as red cross signs).](assets/mdp-0704cb2365/mdp-d8a1da2f85.png)
:width:`250px`
:label:`fig_mdp`
